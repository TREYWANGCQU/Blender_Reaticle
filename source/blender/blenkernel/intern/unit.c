...
static struct bUnitDef buMetricVelDef[] = {
	...
	{ "micrometer per second", "micrometers per second", "um/s", NULL, "MicroMeters per second", UN_SC_MM*UN_SC_MM, 0.0, B_UNIT_DEF_NONE },
	{NULL, NULL, NULL,  NULL, NULL, 0.0, 0.0}
};
...
static struct bUnitDef buMetricTempDef[] = {
	{ "celsius", "celsisu",             "C",   NULL, "Celsius",     UN_SC_CEL, 0.0,      B_UNIT_DEF_NONE },
...
static struct bUnitDef buImperialTempDef[] = {
	{ "fahrenheit", "fahrenheit",             "F",   NULL, "Fahrenheit",     UN_SC_FAH, 32.0,      B_UNIT_DEF_NONE },


	{ NULL, NULL, NULL,	NULL, NULL, 0.0, 0.0 }
};
static struct bUnitCollection buImperialTempCollection = { buImperialTempDef, 0, 0, sizeof(buImperialTempDef) / sizeof(bUnitDef) };
...
static const struct bUnitCollection *bUnitSystems[][B_UNIT_TYPE_TOT] = {
	{NULL, NULL, NULL, NULL, NULL, &buNaturalRotCollection, &buNaturalTimeCollection, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL},
	{NULL, 
